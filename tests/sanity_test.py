...
p2sc_tests = [
  ...
  ("func test 2",
        TestCase(os.path.join(file_locations,'func_test_2.circ'),
                os.path.join(file_locations,'reference_output/func_test_2.sc.out')), "cpu-lite"),
  ("func test 3",
               TestCase(os.path.join(file_locations,'func_test_3.circ'),
                        os.path.join(file_locations,'reference_output/func_test_3.sc.out')), "cpu-end"),
]
